...
import com.xiaoshuotech.cloud.core.util.StringUtil;
 ...
 * 定义常用的 sql关键字
 *
 * @author : hongting.wang
 * @version 1.0
 * @blame Xiaoshuo Team
 * @date 2021-01-04 15:59
 * Copyright(©) XiaoshuoTech 2019-2021 by hongting.wang
 **/
public class SqlKeyword {

    private final static String SQL_REGEX = "'|%|--|insert|delete|select|group|union|drop|truncate|alter|grant|execute|exec|xp_cmdshell|call|declare|sql";
